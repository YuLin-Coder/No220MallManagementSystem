...
export default {
    ...
    methods: {
        ...
        selectSoft() {
            this.$axios.get('/commodityChild/select/' + this.input).then(res => {
                this.tableData = res.data.data;
            });
        },
        addbtn() {
            this.$axios.post('/commodityChild/save', this.addinfoForm).then(res => {
                this.$message({
                    showClose: true,
                    message: '添加成功',
                    type: 'success',
        ...
        update() {
            this.$axios.post('/commodityChild/update', this.infoForm).then(res => {
                this.$message({
                    showClose: true,
                    message: '修改成功',
                    type: 'success',
        ...
        delHandle(id) {
            ...
            console.log(ids);
            this.$axios.post('/commodityChild/delete/' + ids).then(res => {
                this.$message({
                    showClose: true,
                    message: '删除成功',
                    type: 'success',
